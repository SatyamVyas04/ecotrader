...
const WhatWeOfferSection = () => {
  ...
  return (
    <div className="my-4 bg-transparent p-4 md:p-8">
      <h1 className="-z-10 -mb-4 px-2 text-center font-polysans text-5xl font-bold text-white md:-mb-8 md:text-9xl">
        WHAT WE OFFER
      </h1>
          ...
          >
            <div className="grid grid-cols-1 items-start gap-2 md:grid-cols-[auto,1fr] md:gap-8">
              ...
              <div className="space-y-2 md:space-y-4">
                <h2 className="font-polysans text-xl font-bold text-white transition-all group-hover:text-background md:text-3xl xl:text-4xl">
                  {offering.title}
                </h2>
